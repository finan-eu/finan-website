...
export const kingdomDenmarkPartners: Partner[] = [
  {
    ...
    content: [
      ...
      '<a href="https://opintopolku.fi/konfo/en/toteutus/1.2.246.562.17.00000000000000001744" class="text-blue-800 underline hover:text-blue-900">Learn more about the OAMK nursing program</a>.',
    ],
  },
  {
    logo: arcadaLogo,
